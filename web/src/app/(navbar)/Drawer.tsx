    ...
    <div className={className}>
      <Dialog>
        <DialogTrigger asChild>
          <Button
            variant="ghost"
            className="p-2 fill-foreground hover:bg-transparent"
          >
            <Icons.menu className="h-8"></Icons.menu>
          </Button>
        </DialogTrigger>
        <DialogContent className="fixed left-0 translate-x-0 h-[100dvh] w-[75dvw] max-w-[360px] bg-background border p-6 shadow-lg data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left">
